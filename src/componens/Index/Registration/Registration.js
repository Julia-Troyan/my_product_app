    ...
    <div>
      ...
      <div className="registration-box center">
       <div className="registrations">
        ...
        <form action="id" class="registration__form">
        ...
        <div className="registration__button">
          <button className="registration__but">JOIN NOW <span className="registration__but_span"><svg width="17" height="10" viewBox="0 0 17 10" fill="none" xmlns="http://www.w3.org/2000/svg">
